...
const Button = (props: ButtonProps) => {
  return (
    ...
    <button
    className='cursor-pointer flex p-1.5 w-full justify-between text-blue text-button rounded-xl bg-gray-500 hover:text-gray-500 hover:bg-blue transition-colors duration-300'
